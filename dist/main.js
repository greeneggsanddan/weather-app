...
function addEventListeners() {
  ...
  submitBtn.addEventListener('click', (e) => {
    ...
    (0,_dataHandler__WEBPACK_IMPORTED_MODULE_0__["default"])(location).then(data => {
      displayWeather(data);
    });
  });
}
