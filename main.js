...
function getTitle(weather) {
  ...
  date.textContent = 'It is ' + (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(weather.local_time), 'p PPPP');
...
function getForecast(weather) {
  ...
  for (let i = 0; i < 3; i++) {
    ...
    date.textContent = i === 0 ? 'Tommorow' : (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(dateData), 'EEE, MMM d');
...
/* harmony export */ });
class Weather {
  constructor (location, region, country, local_time, current_temp, current_condition, current_code, dates, temps, conditions, codes) {
...
let currentLocation = new _weather__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
function processData(data) {
  ...
  const weatherObj = new _weather__WEBPACK_IMPORTED_MODULE_1__["default"] (location, region, country, local_time, current_temp, current_condition, current_code, dates, temps, conditions, codes);
...
submitBtn.addEventListener('click', (e) => {
  ...
  const locationData = getWeather(location).then(data => {
    (0,_displayHandler__WEBPACK_IMPORTED_MODULE_0__["default"])(data);
  });
});
})();
