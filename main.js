...
/* harmony import */ var _displayHandler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./displayHandler */ "./src/displayHandler.js");
...
async function getWeather(location) {
  try {
    ...
    (0,_displayHandler__WEBPACK_IMPORTED_MODULE_1__["default"])(processData(weatherData));
  } catch (error) {
...
function processData(data) {
  ...
  const weatherObj = new _weather__WEBPACK_IMPORTED_MODULE_0__["default"] (location, region, country, local_time, is_day, current_temp, current_condition, current_code, dates, temps, conditions, codes);
...
const SUNNY = '<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="#FAD02C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-sun"><circle cx="12" cy="12" r="5"></circle><line x1="12" y1="1" x2="12" y2="3"></line><line x1="12" y1="21" x2="12" y2="23"></line><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"></line><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"></line><line x1="1" y1="12" x2="3" y2="12"></line><line x1="21" y1="12" x2="23" y2="12"></line><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"></line><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"></line></svg>';
const MOON = '<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="#0C2D48" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-moon"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>';
const CLOUDY = '<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="#B1D4E0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-cloud"><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"></path></svg>';
const DRIZZLE = '<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="#2E8BC0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-cloud-drizzle"><line x1="8" y1="19" x2="8" y2="21"></line><line x1="8" y1="13" x2="8" y2="15"></line><line x1="16" y1="19" x2="16" y2="21"></line><line x1="16" y1="13" x2="16" y2="15"></line><line x1="12" y1="21" x2="12" y2="23"></line><line x1="12" y1="15" x2="12" y2="17"></line><path d="M20 16.58A5 5 0 0 0 18 7h-1.26A8 8 0 1 0 4 15.25"></path></svg>';
const SNOW = '<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="#E9EAEC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-cloud-snow"><path d="M20 17.58A5 5 0 0 0 18 8h-1.26A8 8 0 1 0 4 16.25"></path><line x1="8" y1="16" x2="8.01" y2="16"></line><line x1="8" y1="20" x2="8.01" y2="20"></line><line x1="12" y1="18" x2="12.01" y2="18"></line><line x1="12" y1="22" x2="12.01" y2="22"></line><line x1="16" y1="16" x2="16.01" y2="16"></line><line x1="16" y1="20" x2="16.01" y2="20"></line></svg>';
...
function displayWeather(data) {
  ...
  body.appendChild(getAllWeather(data));
}
...
function addEventListeners() {
  ...
  submitBtn.addEventListener('click', (e) => {
    ...
    (0,_dataHandler__WEBPACK_IMPORTED_MODULE_0__["default"])(location);
  });
}
...
function getTitle(weather) {
  ...
  date.textContent = 'It is ' + (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(weather.local_time), 'p PPPP');
...
function getAllWeather(weather) {
...
function getForecast(weather) {
  ...
  for (let i = 0; i < 3; i++) {
    ...
    date.textContent = i === 0 ? 'Tommorow' : (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(dateData), 'EEE, MMM d');
    temperature.textContent = Math.round(weather.temps[i]) + '°F';
